...
public class TinyDB {
    ...
    public ArrayList<StockDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<StockDomain> playerList =  new ArrayList<StockDomain>();

        for(String jObjString : objStrings){
            StockDomain player  = gson.fromJson(jObjString,  StockDomain.class);
    ...
    public void putListObject(String key, ArrayList<StockDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(StockDomain player: playerList){
